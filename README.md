    ...
    steps:
      ...
      - name: Create Project
        run: |
          ...
          android { namespace 'com.safeguard.onehub'; compileSdk 34; defaultConfig { applicationId "com.safeguard.onehub"; minSdk 24; targetSdk 34; versionCode 1; versionName "1.0 NDALA" } buildTypes { debug { minifyEnabled false } } }
